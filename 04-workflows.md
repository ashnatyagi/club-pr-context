...
- **Known issues:** Fixed 2026-09-17 — text overlay was cropping long club+event names, causing false QC fails (see changelog). Fixed 2026-09-19 — `Generate SEO Caption` was on a deprecated Groq model, crashing every execution (see changelog). Open: video auto-posting isn't actually wired up — see `09-open-questions.md`.
